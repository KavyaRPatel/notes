(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://kavyarpatel.github.io/notes/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://kavyarpatel.github.io/notes/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://kavyarpatel.github.io/notes/assets/css/just-the-docs-' + theme + ".css"
      );
    };
