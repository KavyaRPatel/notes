(function (jtd, undefined) {
    ...
    function initNavBar() {
      return fetch("https://KavyaRPatel.gitub.io/notes/nav.html").then(function (response) {
    ...
    function initSearch() {
      ...
      request.open("GET", "https://KavyaRPatel.gitub.io/notes/assets/js/search-data.json", true);
    ...
    jtd.setTheme = function (theme) {
      ...
      cssFile.setAttribute(
        "href",
        'https://KavyaRPatel.gitub.io/notes/assets/css/just-the-docs-' + theme + ".css"
      );
    };
